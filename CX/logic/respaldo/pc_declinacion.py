...
def chart_pcd():
    ...
    error = "Error al cargar reporte PCD"
    ...
    if request.method == 'GET':
        try:        
            #Conexion con la DB - KPI's PCD
            kpi_clients = db.collection('PCD_KPIS').order_by("Cliente").get() #Get All PCD KPI's #2022, 2021
